...
### Dataset
- To run the scripts, the dataset should be structered as indictated bellow. Note that for each patient has 4 associated images to them: T1, b1000, ADC and mask. More clarification on the preprocessing steps applied to the image prior to running these scripts can be found in ( add reff later when paper is accapted) 
```
|-- Dataset
|   |-- Train
|   |   |-- Patient_1
